...
test_function_v2("plotly.plotly.plot", params=["filename"],do_eval = False)
...
- Create `trace1` using the available information. Using `month` and `low_2014` in the environment, set `x` and `y` appropriately. The name should be `'Low 2014'`, the color of the line should be defined as `'rgb(22, 96, 167)'`, and the width of the line should be `'4'`. 
